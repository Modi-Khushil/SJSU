...
public class SignUpFragment extends Fragment implements View.OnClickListener {
   ...
   public SignUpFragment() {
        ...
        private void initViews() {
            ...
            ArrayAdapter<CharSequence> adapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, REGION_OPTION);
        ...
        private void signUpUser(final String email, final String password, final String firstName, final String lastName,final String region){
            try {
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener((Activity) requireContext(), task -> {
                    ...
                    if(task.isSuccessful())
                    {
                        ...
                        try {
                            ...
                            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener((Activity) requireContext(), task1 -> {
