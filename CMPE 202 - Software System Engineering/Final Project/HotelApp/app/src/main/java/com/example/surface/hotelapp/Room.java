    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread((() -> {
            ...
            while (i<4) {
                ...
                if (curCount == 0) {
                    imgActivity1.post(() -> imgActivity1.setImageResource(R.drawable.room1));
                }
                else if (curCount == 1) {
                    imgActivity1.post(() -> imgActivity1.setImageResource(R.drawable.room2));
                }
                else if (curCount == 2) {
                    imgActivity1.post(() -> imgActivity1.setImageResource(R.drawable.room3));
                }
                else if (curCount == 3) {
                    i = -1;
                }
        ...
        btn1.setOnClickListener(view -> {
            ...
            try{
                ...
                if (numberOfGuests >= 3)
                {
                    price = numberOfDays * numberOfGuests * 120;
                }
        ...
        btn2.setOnClickListener(view -> {
            // Kings Suite - $180/day
            try{
                String type = "Kings hotel";
                String date = etDate.getText().toString();
                numberOfDays = Integer.parseInt(etNumberOfDays.getText().toString());
                numberOfGuests = Integer.parseInt(etNumberOfGuests.getText().toString());
                if (numberOfGuests >= 3)
                {
                    price = numberOfDays * numberOfGuests * 180;
                }
        ...
        btn3.setOnClickListener(view -> {
            ...
            try{
                ...
                if (numberOfGuests >= 3)
                {
                    price = numberOfDays * numberOfGuests * 220;
                }
