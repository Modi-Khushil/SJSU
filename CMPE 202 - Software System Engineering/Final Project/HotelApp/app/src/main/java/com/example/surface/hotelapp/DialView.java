...
public class DialView extends View {
    ...
    private void startEyesAnimation(int... newPositions) {
        ...
        rightEyeAnimatorX.addUpdateListener(animation -> currEyeRX = (int) animation.getAnimatedValue());
        eyesAnimatorY.setIntValues(currEyeY, newPositions[2]);
        eyesAnimatorY.addUpdateListener(animation -> currEyeY = (int) animation.getAnimatedValue());
