    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(() -> {
            ...
            while (i < 4) {
                ...
                if (curCount == 0) {
                    imgActivity1.post(() -> imgActivity1.setImageResource(R.drawable.kayaking));
                }
                else if (curCount == 1) {
                    imgActivity1.post(() -> imgActivity1.setImageResource(R.drawable.kayaking1));
                }
                else if (curCount == 2) {
                    imgActivity1.post(() -> imgActivity1.setImageResource(R.drawable.kayaking3));
                }
                else if (curCount == 3){
                    i = -1;
                }
        ...
        new Thread(() -> {
            ...
            while (i < 4) {
                ...
                final int curCount = i;
                if (curCount == 0) {
                    imgActivity2.post(() -> imgActivity2.setImageResource(R.drawable.skiing));
                }
                else if (curCount == 1) {
                    imgActivity2.post(() -> imgActivity2.setImageResource(R.drawable.skiing3));
                }
                else if (curCount == 2) {
                    imgActivity2.post(() -> imgActivity2.setImageResource(R.drawable.skiing2));
                }
                else if (curCount == 3){
                    i = -1;
                }
        ...
        new Thread(() -> {
            ...
            while (i < 4) {
                ...
                final int curCount = i;
                if (curCount == 0) {
                    imgActivity3.post(() -> imgActivity3.setImageResource(R.drawable.whistler));
                }
                else if (curCount == 1) {
                    imgActivity3.post(() -> imgActivity3.setImageResource(R.drawable.whistler1));
                }
                else if (curCount == 2) {
                    imgActivity3.post(() -> imgActivity3.setImageResource(R.drawable.whistler2));
                }
                else if (curCount == 3){
                    i = -1;
                }
